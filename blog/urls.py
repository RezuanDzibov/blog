...
urlpatterns = [
    ...
    path('article/<int:day>/<int:month>/<int:year>/<slug:slug>/', views.ArticleDetailView.as_view(), name='article_detail'),
    ...
    path('article_delete_confirm/<pk>/', views.ArticleDelete.as_view(), name='delete_article_confirm'),
    path('article_edit/<int:pk>/', views.ArticleUpdate.as_view(), name='article_edit'),
